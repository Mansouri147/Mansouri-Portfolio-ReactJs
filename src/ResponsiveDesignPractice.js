...
function ResponsiveDesignPractice() {
  ...
  const [skillsTable, setSkillsTable] = useState(["JavaScript", "CSS Hacks ( Animations: Keyframes and media screens )", "Responsive Design", "Web Design", "SVG usage"]);
  ...
  const [projectDescriptions, setProjectDescriptions] = useState("You know that kind of moment when you say :Hey... let's practice some Responsive Design then you immediately do it.");
