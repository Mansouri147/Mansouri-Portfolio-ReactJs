...
import './Business_list.scss';
import './Imobile.scss';
import "./Portfolio_template.scss";
import './TodoListAppDj.scss';
import "./MylilMarket.scss"
import "./BlackJackRPS.scss"
import "./InstagramClone.scss"
import "./FBMessengerClone.scss"
import "./NetflixClone.scss"
import "./ResponsiveDesignPractice.scss"
import './AmazonClone.scss'
import './TinderClone.scss'
import './TikTokClone.scss'
import './YoutubeClone.scss'
import './SpotifyClone.scss'
...
function Page( { projectName, title, secondTitle, liveDemoUrl, githubRepoUrl, flipper_key1, flipper_key2, flipper_key3, flipper_key4,
    flipper_key1Alt, flipper_key2Alt, flipper_key3Alt, flipper_key4Alt, flipper_image1, flipper_image2, flipper_image3,
    flipper_image4, flipper_image5, flipper_image6, flipper_image1Alt, flipper_image2Alt, flipper_image3Alt, cleverProgUrl,
    flipper_image4Alt, flipper_image5Alt, flipper_image6Alt, projectDescriptions, skillsTable, 
    skillsTable2 }) {
